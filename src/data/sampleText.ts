...
It runs entirely in the browser, and you can optionally add an Anthropic or OpenAI API key — or connect a local model — to run deeper analysis and enable auto-edits.
